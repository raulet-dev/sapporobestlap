...
/*
    CarControllerFree class is the main class for controlling the car
*/
public class CarControllerFree : MonoBehaviour {
    public enum CarType
    {
    ...
    void Start() {
        ...
        tmpBrakePower = brakePower;
        tmpMaxMotorTorque = maxMotorTorque;
    ...
    public void Started()
    {
        ...
        brakePower = tmpBrakePower;
        maxMotorTorque = tmpMaxMotorTorque;
    }
    public void Stopped(Vector3 pos)
    {
        started = false;
        maxSpeed = 0;
        maxMotorTorque = 0;
